...
{   
    ros::init(argc, argv, "robot_maker_broadcaster");
    ros::NodeHandle node;
    ...
    platform_marker.header.frame_id = "base_link";
    ...
    platform_marker.mesh_resource ="package://lidar_rotation/meshes/robot_model.stl";
